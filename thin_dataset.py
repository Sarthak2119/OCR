...
def thin_data():
    cwd = os.getcwd()
    for folder in os.listdir(cwd + '/Fnt/'):
        path = cwd + '/Fnt/' + folder
...
for files in os.listdir(path):
    ...
    #     print (imges)
        ...
        #val = path + '/' + sub_folder + '/' + files + '/' + imges
        # print(val)
#
print (cnt)
#
...
#     for folder in os.listdir(cwd + '/Img/'):
#         if folder == 'GoodImg':
#             path = cwd + '/Img/' + folder
#             for sub_folder in os.listdir(path):
#                 if sub_folder == 'Bmp':
#                     for files in os.listdir(path + '/' + sub_folder):
#                         character_value = int((files[6:len(files)]))
#                         # print (files)
#                         # print (character_value)
#                         real_value = 0
...
#                         # print(real_value)
#
#                         path2 = os.listdir(path + '/' + sub_folder + '/' + files)
#                         y = (len(path2))
#                         cnt = 0
#                         boudary = (y * 86) / 100
#                         # print (boudary)
